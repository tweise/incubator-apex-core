...
public class PhysicalPlanTest
{
  ...
  public void testRepartitioningScaleUp()
  {
    ...
    expUndeploy.addAll(getUnifierStartingWithName(plan, o2Meta.getName()));
    ...
    expDeploy.addAll(getUnifierStartingWithName(plan, o2Meta.getName()));
  ...
  public void testRepartitioningScaleDown()
  {
    ...
    Collection<PTOperator> o3unifiers = getUnifierStartingWithName(plan, o3Meta.getName());
    ...
    o3unifiers = getUnifierStartingWithName(plan, o3Meta.getName());
  ...
  public void testRepartitioningScaleDownSinglePartition()
  {
    ...
    List<PTOperator> o1NewUnifiers = getUnifierStartingWithName(plan, o1Meta.getName());
    ...
    o1NewUnifiers.addAll(getUnifierStartingWithName(plan, o1Meta.getName()));
  ...
  public void testAugmentedDynamicPartitioning()
  {
    ...
    Collection<PTOperator> operators = plan.getAllOperators().values();

    PTOperator unifier = null;
  ...
  private List<PTOperator> getUnifierStartingWithName(PhysicalPlan plan, String name)
  {
    ...
    for (PTOperator operator : plan.getAllOperators().values()) {

      if (operator.isUnifier()) {
        if (operator.getName().startsWith(name)) {
          result.add(operator);
        }
      }
    }
